...
int main(){
    ...
    cout << "The sixth high temperature is: " << hi_temps[2] << endl; // this will be garbage - don't do this!
    ...
    cout << "movie_rating[0][0]: " << movie_rating[0][0] << endl;
    cout << "movie_rating[0][1]: " << movie_rating[0][1] << endl;
